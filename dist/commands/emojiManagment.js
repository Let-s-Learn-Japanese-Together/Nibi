...
const emojiManagement = {
    ...
    async execute(interaction, env) {
        ...
        const subcommand = interaction.data.options?.find((o) => o.type === 1)?.name;
        ...
        if (subcommand === 'lock' || subcommand === 'unlock') {
            ...
            if (subcommand === 'lock') {
                try {
                    const emojiInputOption = interaction.data.options?.find((o) => o.name === 'emoji');
                    ...
                    const role = interaction.data.options?.find((o) => o.name === 'role' && o.type === 8);
                    if (!role) {
